...
const Country = ({country, isVisited, handleCountriesVisited}) => {
  ...
  return (
    <div style={{border: '2px solid blue', padding: '10px', borderRadius: '12px', backgroundColor: isVisited ? '#88e827' : '#f9faf8'}}>
      ...
      <button style={{padding: '8px', marginTop: '10px', borderRadius: '5px', fontWeight: 'bold', fontSize: '18px'}} onClick={() => handleClick(country)}>{isVisited ? 'Visited' : 'Not Visited'}</button>
    </div>
  );
};
